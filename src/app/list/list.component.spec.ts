...
describe('ListComponent', () => {
  ...
  it('should filter the customers accordingly', inject([DataService], (service: DataService) => {
    ...
    console.log(list.searchCustomersList);
    expect(list.searchCustomersList).toEqual([
      Object({ name: 'Jeremy Clarke', age: 21, id: 12345, gender: 'Male', location: 'Melbourne', income: '$120,000' }),
      Object({ name: 'Sparsh Saxena', age: 25, id: 13345, gender: 'Male', location: 'Philadephia', income: '$200,000' }),
      Object({ name: 'Stuart McGill', age: 32, id: 19945, gender: 'Male', location: 'Arlington', income: '$400,000' }),
      Object({ name: 'Erica Edwards', age: 25, id: 11145, gender: 'Female', location: 'Toronto', income: '$2,200,000' })
    ]);
  }));
